...
#include "ucb_interface/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ucb_interface::msg::Sphere & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ucb_interface::msg::Sphere & ros_message)
{
  // Member: center
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ucb_interface::msg::Sphere;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ucb_interface::msg::Sphere *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ucb_interface::msg::Sphere *>(
    untyped_ros_message);
...
{
  return &ucb_interface::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ucb_interface, msg, Sphere)() {
  return &ucb_interface::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
