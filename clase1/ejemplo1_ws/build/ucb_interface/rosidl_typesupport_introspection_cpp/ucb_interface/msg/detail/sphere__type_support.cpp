...
{
  new (message_memory) ucb_interface::msg::Sphere(_init);
}

void Sphere_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ucb_interface::msg::Sphere *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Sphere_message_member_array[2] = {
  {
    ...
    offsetof(ucb_interface::msg::Sphere, center),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ucb_interface::msg::Sphere, radius),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Sphere_message_members = {
  ...
  "Sphere",  // message name
  2,  // number of fields
  sizeof(ucb_interface::msg::Sphere),
...
get_message_type_support_handle<ucb_interface::msg::Sphere>()
{
  return &::ucb_interface::msg::rosidl_typesupport_introspection_cpp::Sphere_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ucb_interface, msg, Sphere)() {
  return &::ucb_interface::msg::rosidl_typesupport_introspection_cpp::Sphere_message_type_support_handle;
}
